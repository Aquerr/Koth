...
public class CreateLobbyCommand extends AbstractCommand
{
	...
	public CommandResult execute(final CommandSource source, final CommandContext args) throws CommandException
	{
		...
		player.sendMessage(Text.of(PluginInfo.PLUGIN_PREFIX, "If you are done with the lobby. You can now setup spawn lobby on the arena. Stand in a position where lobby spawn should be placed.", TextColors.GOLD, "/koth createlobbyspawn", TextColors.WHITE, " to create a spawn lobby.\n" +
