...
public class CreateArenaCommand extends AbstractCommand
{
    ...
    public CommandResult execute(final CommandSource source, final CommandContext args) throws CommandException
    {
        ...
        player.sendMessage(Text.of(PluginInfo.PLUGIN_PREFIX, "Now it is time to set up lobby for the arena. Select two points with your wand and type ", TextColors.GOLD, "/koth createlobby", TextColors.WHITE, " to create a lobby."));
        return CommandResult.success();
    }
}
