...
public class CreateArenaCommand extends AbstractCommand
{
    ...
    public CommandResult execute(final CommandSource source, final CommandContext args) throws CommandException
    {
        ...
        player.sendMessage(Text.of(PluginInfo.PLUGIN_PREFIX, "Now it is time to set up hills in the arena. Select two points with your wand and type ", TextColors.GOLD, "/koth createhill <name>", TextColors.WHITE, " to create a hill.\n" +
